<form id="projectBasicForm" data-projectId="<?php echo $projectId;?>" data-confirmation="1">
<div class="default-header">
	<div class="container">
		<div class="row">
			<p class="project-title span12">Confirm Completed Project Details</p>
			<p class="project-description span7">You can edit your project profile for 1 week 
				after you archive it.  After that point, your project will be a permanent 
				portfolio for the world to see!</p>
			<button id="confirm_completion" type="submit"
				class="btn btn-large btn-block btn-success">Confirm</button>
		</div>
	</div>
</div>
